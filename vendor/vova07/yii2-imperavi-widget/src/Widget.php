...
class Widget extends BaseWidget
{
    ...
    public $available_langs = ['de', 'en', 'pt-BR', 'ro', 'ru'];
    ...
    public function init()
    {
        ...
        if (isset($this->settings['lang'])) {
            $this->settings['lang'] = in_array($this->settings['lang'], $this->available_langs) ? $this->settings['lang'] : 'en';
        } else {
            $this->settings['lang'] = in_array(Yii::$app->language, $this->available_langs) ? Yii::$app->language : 'en';
        }
