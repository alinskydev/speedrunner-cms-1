...
CREATE TABLE `BannerImage` (
  ...
  CONSTRAINT `bannerimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Banner` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BannerImageTranslation` (
  ...
  PRIMARY KEY (`id`),
  KEY `bannerimagetranslation_ibfk_1` (`item_id`),
  CONSTRAINT `bannerimagetranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `BannerImage` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BlockImage` (
  ...
  PRIMARY KEY (`id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `blockimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Block` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BlockPageTranslation` (
  ...
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `blockpagetranslation_ibfk_1` (`item_id`),
  CONSTRAINT `blockpagetranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `BlockPage` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BlockTranslation` (
  ...
  `value` text,
  PRIMARY KEY (`id`),
  KEY `blocktranslation_ibfk_1` (`item_id`),
  CONSTRAINT `blocktranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Block` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `Blog` (
  ...
  CONSTRAINT `blog_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `BlogCategory` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `BlogCategoryTranslation` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `blogcategorytranslation_ibfk_1` (`item_id`),
  CONSTRAINT `blogcategorytranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `BlogCategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BlogComment` (
  ...
  CONSTRAINT `blogcomment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BlogImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `blogimage_ibfk_1` (`item_id`),
  CONSTRAINT `blogimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `BlogRate` (
  ...
  CONSTRAINT `blograte_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `BlogTranslation` (
  ...
  PRIMARY KEY (`id`),
  KEY `blogtranslation_ibfk_1` (`item_id`),
  CONSTRAINT `blogtranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `GalleryImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `galleryimage_ibfk_1` (`item_id`),
  CONSTRAINT `galleryimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Gallery` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MenuTranslation` (
  ...
  PRIMARY KEY (`id`),
  KEY `menutranslation_ibfk_1` (`item_id`),
  CONSTRAINT `menutranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Menu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `PageTranslation` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `pagetranslation_ibfk_1` (`item_id`),
  CONSTRAINT `pagetranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Page` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Product` (
  ...
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `ProductBrand` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `product_ibfk_2` FOREIGN KEY (`main_category_id`) REFERENCES `ProductCategory` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `ProductAttributeOptionTranslation` (
  ...
  PRIMARY KEY (`id`),
  KEY `productattributeoptiontranslation_ibfk_1` (`item_id`),
  CONSTRAINT `productattributeoptiontranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ProductAttributeOption` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ProductAttributeTranslation` (
  ...
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `productattributetranslation_ibfk_1` (`item_id`),
  CONSTRAINT `productattributetranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ProductAttribute` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ProductBrandTranslation` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `productbrandtranslation_ibfk_1` (`item_id`),
  CONSTRAINT `productbrandtranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ProductBrand` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ProductCategoryTranslation` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `productcategorytranslation_ibfk_1` (`item_id`),
  CONSTRAINT `productcategorytranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ProductCategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ProductComment` (
  ...
  CONSTRAINT `productcomment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ProductImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `productimage_ibfk_1` (`item_id`),
  CONSTRAINT `productimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ProductRate` (
  ...
  CONSTRAINT `productrate_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ProductTranslation` (
  ...
  `full_description` text,
  PRIMARY KEY (`id`),
  KEY `producttranslation_ibfk_1` (`item_id`),
  CONSTRAINT `producttranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ProductVariationImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `productvariationimage_ibfk_1` (`item_id`),
  CONSTRAINT `productvariationimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ProductVariation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SeoMeta` VALUES (3,'Blog',11,'en','{\"title\":{\"property\":\"title\",\"content\":\"\"},\"description\":{\"name\":\"description\",\"content\":\"\"},\"og:title\":{\"property\":\"og:title\",\"content\":\"\"},\"og:description\":{\"property\":\"og:description\",\"content\":\"\"},\"og:image\":{\"property\":\"og:image\",\"content\":\"\"}}');
...
CREATE TABLE `StaticPageBlockImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `staticpageblockimage_ibfk_1` (`item_id`),
  CONSTRAINT `staticpageblockimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `StaticPageBlock` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `StaticPageBlockTranslation` (
  ...
  `value` text,
  PRIMARY KEY (`id`),
  KEY `staticpageblocktranslation_ibfk_1` (`item_id`),
  CONSTRAINT `staticpageblocktranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `StaticPageBlock` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Zzz` (
  ...
  CONSTRAINT `zzz_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `ZzzCategory` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ZzzCategoryTranslation` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `zzzcategorytranslation_ibfk_1` (`item_id`),
  CONSTRAINT `zzzcategorytranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `ZzzCategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ZzzImage` (
  ...
  `sort` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `zzzimage_ibfk_1` (`item_id`),
  CONSTRAINT `zzzimage_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Zzz` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ZzzTranslation` (
  ...
  `full_description` text,
  PRIMARY KEY (`id`),
  KEY `zzztranslation_ibfk_1` (`item_id`),
  CONSTRAINT `zzztranslation_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `Zzz` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-13  0:46:46
