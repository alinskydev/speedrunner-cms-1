            ...
            <div id="tab-images" class="tab-pane fade">
                <?= $form->field($model, 'images', [
                    ...
                    'pluginOptions' => array_merge(Yii::$app->params['fileInput_pluginOptions'], [
                        'deleteUrl' => Yii::$app->urlManager->createUrl(['gallery/gallery/image-delete', 'id' => $model->id, 'attr' => 'images']),
                    ...
                    'pluginEvents' => [
                        'filesorted' => new JsExpression("function(event, params) {
                            $.post('".Yii::$app->urlManager->createUrl(['gallery/gallery/image-sort', 'id' => $model->id, 'attr' => 'images'])."', {sort: params});
                        }")
                    ],
                ]); ?>
            </div>
